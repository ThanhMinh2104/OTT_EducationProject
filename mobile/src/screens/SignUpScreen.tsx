        ...
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          ...
          <LinearGradient colors={['#60aef8', '#3b90f4', '#2572e9']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.headerGradient}>
            ...
            <Animated.View style={[styles.brandingContainer, { transform: [{ scale: logoScale }] }]}>
              ...
              <Text style={styles.appSubtitle}>Tạo tài khoản để bắt đầu hành trình học tập</Text>
            </Animated.View>
          </LinearGradient>
          ...
          <Animated.View style={[styles.card, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
            <View style={styles.cardHeader}>
              ...
              <Text style={styles.cardSubtitle}>Nhập thông tin để tạo tài khoản mới</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    shadowColor: '#3b90f4', shadowOffset: { width: 0, height: 8 },
    shadowOpacity: 0.15, shadowRadius: 24, elevation: 10,
    borderWidth: 1, borderColor: 'rgba(59,144,244,0.08)',
  },
