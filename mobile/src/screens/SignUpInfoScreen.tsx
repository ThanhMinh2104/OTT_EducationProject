...
const SignUpInfoScreen = ({ navigation, route }: Props) => {
  ...
  useEffect(() => {
    ...
    else if (birth && validateDateFormat(birth) && !validateAge(birth))
      setError("Bạn phải từ 18 tuổi trở lên.");
    else if (password && !isValidPassword(password))
      setError("Mật khẩu tối thiểu 8 ký tự, có ít nhất 1 chữ và 1 số.");
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Thành công",
        "Đăng ký thành công! Chào mừng bạn đến với OTT Education 🎉",
      );
          ...
          >
            <View style={styles.cardHeader}>
              ...
              <Text style={styles.cardSubtitle}>
                Điền đầy đủ để hoàn tất đăng ký 📝
              </Text>
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.genderRow}>
                {["Nam", "Nữ"].map((g) => (
                  ...
                  >
                    <Ionicons
                      name={g === "Nam" ? "male-outline" : "female-outline"}
                      size={18}
            ...
            <TouchableOpacity
              ...
              disabled={!enabled || loading || !agreeTerms}
              activeOpacity={0.85}
            >
              <LinearGradient
                colors={["#60aef8", "#3b90f4", "#2572e9"]}
                ...
                style={[
                  styles.btnPrimary,
                  (!enabled || loading || !agreeTerms) && styles.btnDisabled,
                ]}
              >
                {loading ? (
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Bằng việc đăng ký và sử dụng dịch vụ, bạn đồng ý tuân thủ các
                  điều khoản sau.
                </Text>
                ...
                >
                  • Sử dụng dịch vụ cho mục đích cá nhân, hợp pháp
                </Text>
                <Text
                  style={{
                    fontSize: 14,
                ...
                >
                  • Chia sẻ nội dung vi phạm pháp luật
                </Text>
                <Text
                  style={{
                    fontSize: 14,
                ...
                >
                  • Vi phạm trung bình: Khóa tạm thời (7-30 ngày)
                </Text>
                <Text
                  style={{
                    fontSize: 14,
