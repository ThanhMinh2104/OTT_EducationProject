...
const SignUpInfoScreen = () => {
  ...
  const inputClass = "w-full pl-12 pr-4 py-3.5 bg-gray-50 border-2 border-gray-200 rounded-xl text-gray-800 text-sm placeholder-gray-400 transition-all duration-300 focus:outline-none focus:border-primary-400 focus:bg-white focus:ring-4 focus:ring-primary-100 hover:border-gray-300";
          ...
          <div className="max-w-md animate-slide-in-left">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-white/30 flex items-center justify-center text-white text-sm font-bold">✓</div>
                <span className="text-white/70 text-sm">Xác thực</span>
              </div>
              <div className="w-8 border-t border-white/30" />
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-primary-600 text-sm font-bold">2</div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input id="name-input" type="text" placeholder="Nhập họ và tên" className={inputClass} value={name} onChange={(e) => setName(e.target.value)} />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input id="birth-input" type="text" placeholder="dd/mm/yyyy" className={inputClass} value={birth} onChange={(e) => setBirth(e.target.value)} />
                </div>
              </div>
                ...
                <div className="flex gap-3">
                  {['Nam', 'Nữ'].map((g) => (
                    <button
                      ...
                      type="button"
                      onClick={() => setGender(g)}
                      className={`flex-1 py-3 rounded-xl text-sm font-medium transition-all duration-300 cursor-pointer ${gender === g
                          ? 'bg-gradient-to-r from-primary-400 to-primary-500 text-white shadow-lg shadow-primary-300/30'
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input id="password-input" type="password" placeholder="Tối thiểu 8 ký tự, gồm chữ và số" className={inputClass} value={password} onChange={(e) => setPassword(e.target.value)} />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input id="repassword-input" type="password" placeholder="Nhập lại mật khẩu" className={inputClass} value={rePassword} onChange={(e) => setRePassword(e.target.value)} />
                </div>
              </div>
