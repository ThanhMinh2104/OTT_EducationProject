...
const ToastMessage = ({ avatar, senderName, message, chatID, onClickChat }: ToastMessageProps) => {
  return (
    <div
      ...
      className="flex items-center gap-3 bg-white dark:bg-gray-800 rounded-xl shadow-[0_8px_32px_rgba(0,0,0,0.12)] p-3 min-w-[320px] max-w-[380px] cursor-pointer hover:shadow-[0_12px_40px_rgba(0,0,0,0.18)] transition-all duration-200 border border-gray-100 dark:border-gray-700"
    >
      {/* Avatar */}
      ...
      <div className="flex-1 min-w-0">
        <p className="text-[14px] font-semibold text-gray-900 dark:text-gray-100 truncate mb-0.5">
          {senderName}
        </p>
