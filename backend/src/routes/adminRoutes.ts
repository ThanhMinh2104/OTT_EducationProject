...
router.post('/admin/users/:userID/lock', authMiddleware, adminMiddleware, async (req: Request, res: Response) => {
  try {
...
router.post('/admin/users/:userID/unlock', authMiddleware, adminMiddleware, async (req: Request, res: Response) => {
  try {
    const { userID } = req.params;
